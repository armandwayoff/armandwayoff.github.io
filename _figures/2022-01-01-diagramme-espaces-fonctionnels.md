...
Il n'y a pas d'inclusion entre les espaces $L^1$ et $L^2$ mais on a $L^2_\mathrm{loc} \subset L^1_\mathrm{loc}$, espaces qui prendraient place sur la verticale de droite. $\subset$, $a\mathrm{a}$.
